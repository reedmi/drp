Ext.define('drp.app.view.users.WareKeeperView', {
    ...
    margins : '0 0 0 0',
    border : 0,
    title : '<center height=40>库管员</center>',
    autoScroll : true,
    closable : true,
    layout : {
        type : 'border'
        ...
        var selModel = Ext.create('Ext.selection.CheckboxModel', {
            listeners : {
                selectionchange : function(sm, selections) {
                    me.down('#deleteWareKeeper_itemId').setDisabled(selections.length == 0);
                }
            }
        });
        Ext.applyIf(me, {
            items : [{
                ...
                dockedItems : [{
                    ...
                    items : [{
                        ...
                        action : 'addWareKeeper',
                        text : '新增'
                    }, '-', {
                        xtype : 'button',
                        icon : 'resources/images/icons/delete.png',
                        action : 'deleteWareKeeper',
                        itemId : 'deleteWareKeeper_itemId',
                        disabled : true,
                        text : '注销'
                    }]
                }, {
